...
public class TheatreController implements UIURLConstants, UIConstants {
	...
	@RequestMapping(value = "/oa/json/getsample", method = RequestMethod.GET)
	public MovieShow sample() throws ServiceDownIOException {
		MovieShow movieShow2 = new MovieShow();
		movieShow2.setShowDate(new Date());
		movieShow2.setShowTimingFrom(new Date());
